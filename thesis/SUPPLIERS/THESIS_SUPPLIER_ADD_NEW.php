    ...
    <div class="block-weighted">
        <div class="weight-70">
            <div class="weight-50 bg-light border px-1 mx-5 dual-content-left">
                <form id="new_product" action="./THESIS_SUPPLIER_ADD_NEW_SUBMIT_test.php" method="POST">
                    <b>
            ...
            <div class="weight-50 bg-light border px-1 mx-5 dual-content-left">
                ...
                <div class="block-weighted mb-1">
                    ...
                    <div class="weight-50 mb-1">
                        ...
                        <br>
                        <input class="half-field" id="PRODUCT_QUANTITY" name="PRODUCT_QUANTITY" type="text" value="">
                    </div>
                </div>
                <div class=" pb-1">
                        <label for="SUPPLIER_PRICE">Supplier Price </label>
                        <br>
                        <input class="full-field less" type="text" id="SUPPLIER_PRICE" name="SUPPLIER_PRICE" value="">
                    </div>
            </div>
