    ...
    <div class="block-weighted">
        <div class="weight-70">
            <div class="weight-50 bg-light border px-1 mx-5 dual-content-left">
                ...
                <!-- PERSONAL INFO -->
                <form id="new_product" action="./THESIS_CUSTOMER_SUBMIT_UPDATE.php" method="POST">
                    <b>
                ...
                <form id="new_product" action="./THESIS_ORDER_ADD_NEW_SUBMIT.php" method="POST">
                    ...
                    <div class="block-weighted mb-1">
                        <div class="weight-50 mb-1">
                            ...
                            <br>
                            <input class="half-field" type="text" id="CUSTOMER_NAME" name="CUSTOMER_NAME" value="<?php echo $userid['CUSTOMER_NAME']; ?>">
                        </div>
                        <div class="weight-50 mb-1">
                            <label for="PHONE_NO">Phone Number </label>
                            <br>
                            <input class="half-field" type="tel" id="contact" name="PHONE_NO" value="<?php echo $userid['PHONE_NO']; ?>" >
                        </div>
                    </div>
                    <div class=" pb-1">
                    <label for="CUSTOMER_ADDRESS">Customer Address</label>
                    <br>
                    <input class="full-field" type="text" id="CUSTOMER_ADDRESS" name="CUSTOMER_ADDRESS" value="<?php echo $userid['CUSTOMER_ADDRESS']; ?>">
                </div>
